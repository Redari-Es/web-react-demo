...
rounded-l-full border border-secondary-border shadow-inner shadow-secondary py-1 px-4 text-lg w-full focus:border-blue-500 outline-none"/>
...
<div className={`flex-shrink-0 md:gap-2k ${showFullWidthSearch ?"hidden":"flex"}`}>
